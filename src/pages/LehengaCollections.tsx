...
const LehengasCollection = () => {
  usePageTitle("Bridal Lehenga Collection | Asha Boutique");
          ...
          <div className="max-w-4xl mx-auto text-center">
            <nav className="flex justify-center mb-6">
              <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
                ...
                <li>/</li>
                <li className="text-foreground">Lehengas</li>
              </ol>
            </nav>
            ...
            <p className="text-lg text-muted-foreground">
              Explore our exquisite collection of lehengas, perfect for weddings and festive occasions.
            </p>
            {error && (
        ...
        <div className="container mx-auto px-4">
          {loading ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8">
              {lehengas.map((lehenga) => (
                <ProductCard 
                  ...
                  image={
                    lehenga.public_id
                      ? (buildCloudinaryImageUrl(lehenga.public_id) || "/placeholder.svg")
                      : lehenga.image
                        ? (buildUploadUrl(lehenga.image) || "/placeholder.svg")
                        : "/placeholder.svg"
                  }
                  category={lehenga.category}
                  isNew={lehenga.isNew}
                />
              ))}
            </div>
            ...
            <div className="text-center py-12">
              <p className="text-muted-foreground text-lg">No lehengas found in the collection.</p>
            </div>
          )}
        </div>
      </section>
